        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-12 col-lg-6">
                    <form action="{{ base_url() }}quis/update/{{ $data->id }}" method="POST" class="card">
                        <div class="card-body">
