<?php $__env->startSection('title', 'Add Quis'); ?>
        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-12 col-lg-6">
                    <form action="<?php echo e(base_url()); ?>quis/store" method="POST" class="card">
                        <div class="card-body">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\mantra-hindu\application\views/quis/add.blade.php ENDPATH**/ ?>